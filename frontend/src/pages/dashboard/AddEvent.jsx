        ...
        <div className="overflow-hidden bg-white rounded-lg shadow-md">
          ...
          <div className="px-4 py-2 border-t border-gray-200 bg-gray-50">
            <div className="grid grid-cols-2">
              <button className="p-2 text-xl font-semibold hover:border-b-2 hover:border-black">
                Kategori Event
              </button>
              <button className="p-2 text-xl font-semibold hover:border-b-2 hover:border-black">
                Deskripsi Event
            ...
            <div className="flex mt-2 space-x-4">
              <button className="flex-1 py-2 text-white bg-blue-500 rounded-md">
                Buat Tiket Berbayar
              </button>
              <button className="flex-1 py-2 text-white bg-blue-500 rounded-md">
                Buat Tiket Gratis
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                  ...
                  <label
                    htmlFor="toggle"
                    className="block h-6 overflow-hidden bg-gray-300 rounded-full cursor-pointer toggle-label"></label>
                </div>
              </div>
              <div className="flex items-center justify-between mt-4">
                <div>
